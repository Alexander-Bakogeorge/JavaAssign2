...
public class RemovelItemListener implements ActionListener {
	
	//calls the removelast method on the object (only works on the traincar)
	//@param ActionEvent e, not used
	public void actionPerformed(ActionEvent e) {
		DrawComponent.list.get(0).removelast();
